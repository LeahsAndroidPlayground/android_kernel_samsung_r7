cmd_arch/arm64/kernel/asm-offsets.s := aarch64-none-linux-gnu-gcc -Wp,-MD,arch/arm64/kernel/.asm-offsets.s.d -nostdinc -isystem /nix/store/mipmcm59d4xw63grxzwjy23fqfk1nji8-gcc-aarch64-linux-gnu-14.3.rel1/bin/../lib/gcc/aarch64-none-linux-gnu/14.3.1/include -I./arch/arm64/include -I./arch/arm64/include/generated/uapi -I./arch/arm64/include/generated  -I./include -I./arch/arm64/include/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/kconfig.h -D__KERNEL__ -mlittle-endian -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -fshort-wchar -Werror-implicit-function-declaration -Wno-format-security -Werror -std=gnu89 -fno-PIE -mgeneral-regs-only -DCONFIG_AS_LSE=1 -fno-asynchronous-unwind-tables -mpc-relative-literal-loads -fno-pic -fno-delete-null-pointer-checks -Wno-frame-address -Wno-format-truncation -Wno-format-overflow -Wno-int-in-bool-context -Wno-address-of-packed-member -Wno-attribute-alias -Os -Wno-maybe-uninitialized -DCC_HAVE_ASM_GOTO -Wframe-larger-than=4096 -fstack-protector-strong -Wno-unused-but-set-variable -Wno-unused-const-variable -fno-omit-frame-pointer -fno-optimize-sibling-calls -fno-var-tracking-assignments -g -fno-jump-tables -Wdeclaration-after-statement -Wno-pointer-sign -Wno-stringop-truncation -fno-strict-overflow -fno-merge-all-constants -fmerge-constants -fno-stack-check -fconserve-stack -Werror=implicit-int -Werror=strict-prototypes -Werror=date-time -Werror=incompatible-pointer-types -Wno-packed-not-aligned    -DKBUILD_BASENAME='"asm_offsets"'  -DKBUILD_MODNAME='"asm_offsets"'  -fverbose-asm -S -o arch/arm64/kernel/asm-offsets.s arch/arm64/kernel/asm-offsets.c
...
deps_arch/arm64/kernel/asm-offsets.s := \
  ...
  /nix/store/mipmcm59d4xw63grxzwjy23fqfk1nji8-gcc-aarch64-linux-gnu-14.3.rel1/lib/gcc/aarch64-none-linux-gnu/14.3.1/include/stdarg.h \
  ...
  include/linux/exynos-ss.h \
    ...
    $(wildcard include/config/exynos/snapshot/uart.h) \
